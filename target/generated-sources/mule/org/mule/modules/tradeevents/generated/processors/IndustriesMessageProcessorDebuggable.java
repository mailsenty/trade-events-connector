...
public class IndustriesMessageProcessorDebuggable
    extends IndustriesMessageProcessor
    implements DebugInfoProvider
{


    public IndustriesMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("industries", "Industries", (java.lang.String.class), industries, muleEvent));
