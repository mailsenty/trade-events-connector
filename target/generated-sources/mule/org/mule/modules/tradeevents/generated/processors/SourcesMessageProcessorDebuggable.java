...
public class SourcesMessageProcessorDebuggable
    extends SourcesMessageProcessor
    implements DebugInfoProvider
{


    public SourcesMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("sources", "Sources", (java.lang.String.class), sources, muleEvent));
