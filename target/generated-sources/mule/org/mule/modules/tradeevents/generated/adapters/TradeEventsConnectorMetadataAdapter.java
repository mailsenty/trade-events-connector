...
/**
 * A <code>TradeEventsConnectorMetadataAdapter</code> is a wrapper around {@link TradeEventsConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-07-23T02:49:49-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class TradeEventsConnectorMetadataAdapter
    extends TradeEventsConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "TradeEvents";
