...
public class CountriesMessageProcessorDebuggable
    extends CountriesMessageProcessor
    implements DebugInfoProvider
{


    public CountriesMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("countries", "Countries", (java.lang.String.class), countries, muleEvent));
